...
Take the human dorsolateral prefrontal cortex (DLPFC) dataset of 10X Visium generated by Maynard et al. (*Nature Neuroscience*, 2021) as the example input data, including three types of files: (1) gene expression data, (2) spatial location data, and (3) ground-truth labels for each spot. These input files are available at `Datasets/DLPFC`.
